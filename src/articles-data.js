...
Do I take the time to think before speaking?`,
...

  {
    ...
    date: '2026-09-01',
    description: 'Latin did not leave the Mass by decree but by comfort, and a preference never has to explain itself, so the reason for it was never handed down either.',
    tags: ['Reflection', 'Faith'],
    img: '',
    highlight: true,
